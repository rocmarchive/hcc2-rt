...
macro(add_ocl_bc_library name dir)
  set(cl_cmd ${HCC2_BINDIR}/clang
    ...
    -I${LIBAMDGCN_ROOTDIR}/${mcpu}/include
    -I${LIBOMPTARGET_DEP_ATMI_INCLUDE_DIRS}
    -I${HCC2_INCDIR})
  ...
  add_custom_command(
    ...
    COMMAND ${HCC2_BINDIR}/llvm-link ${ll_files} -o linkout.ocl.${mcpu}.bc
    DEPENDS ${ll_files}
    )
