...
//FIXME: WorkFn is not a function pointer to the parallel worker, but hash code
// of the function name. For now it is plausible safe since no call in openmp runtime
// is made through this pointer. Otherwise undefined behavior is expected.
