...
#else
  return GetBlockIdInKernel() * GetNumberOfThreadsInBlock() +
         GetThreadIdInBlock();
#endif
}
...
INLINE int GetGlobalTeamId() { return GetBlockIdInKernel(); }

INLINE int GetNumberOfGlobalTeamIds() { return GetNumberOfBlocksInKernel(); }
