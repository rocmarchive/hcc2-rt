...
int main(int argc, char *argv[])
{
    ...
    __tgt_offload_entry *entries = (__tgt_offload_entry *)malloc(sizeof(__tgt_offload_entry) * g_symbols.size());
    ...
    int64_t arg_sizes[] = {sizeof(int), N * sizeof(int), N * sizeof(int), N * sizeof(int)};
    int32_t arg_types[] = {tgt_map_to, tgt_map_to, tgt_map_to, tgt_map_from};
#endif

    // launch 
    int x = __tgt_target(device_id, host_ptr, arg_num,
